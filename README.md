...
- Μερικές φορές δε κάνει render το starting hand των παικτών ενώ έχει αναβαθμιστεί η βάση. Το πρόβλημα λυνέται αν ξαναπαμε στο ιδιο URL. Είναι λογικά πρόβλημα με το EJS και το templating. Η επίλυση θέλει παραπάνω επιθεώρηση.
