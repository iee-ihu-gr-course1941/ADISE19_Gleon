ΑΔΙΣΕ Project
Online Card Game - ΞΕΡΗ<br/>
**ΣΗΜΑΝΤΙΚΟ**<br/>
Λόγω των περιορισμών που υπάρχουν στην εφαρμογή, για να παίξετε πρέπει να κάνετε ενα /reset για σβηνουν τα χαρακτηριστικα και οι χρηστες του προηγουμενου παιχνιδιού (αν υπάρχουν). Μετά κάνετε κανονικά εγγραφή δύο παίκτες και συνδέεστε και ακολουθείτε τα βήματα.
